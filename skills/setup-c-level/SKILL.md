---
name: setup-c-level
description: Bootstraps the AI C-Suite executive workspace, creates or enriches AGENTS.md with strategic guidelines, and scaffolds the c-suite/ artifacts directory in any existing codebase. Triggers on /setup-c-level.
---
